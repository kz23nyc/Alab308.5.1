...
function findLongestString(strings) {
  ...
  console.log(findLongestString(['Cherry','Watermelon','Apricot','Raspberry','Avocado'])); //Watermelon
...
console.log(findLongestString(['Say','Hello beautiful','in','the','Good morning'])); //Hello beautiful
